...
public class Size {
	...
	/*
	 * private int Nr; private int Nmcms; private int Nmcmd; private int Nmcrms;
	 * private int Nmcrmd; private int Nrmcrms; private int Nrmcrmd; private int
	 * Nrmcms; private int Nrmcmd; private int Nmrgvs; private int Nmrgvd; private
	 * int Nrmrgvs; private int Nrmrgvd;
	 */
	...
	/*
	 * private int totr; private int totmcms; private int totmcmd; private int
	 * totmcrms; private int totmcrmd; private int totrmcrms; private int totrmcrmd;
	 * private int totrmcms; private int totrmcmd; private int totmrgvs; private int
	 * totmrgvd; private int totrmrgvs; private int totrmrgvd;
	 */
	...
	public static void setDefaultWeights() {
		...
		weights[4] = 1;
		/*
		 * weights[5] = 4; weights[6] = 5; weights[7] = 3; weights[8] = 4; weights[9] =
		 * 1; weights[10] = 2; weights[11] = 1; weights[12] = 2;
		 */
	}
	...
	public static void setCustomWeights(int Nkw, int Nid, int Nop, int Nnv, int Nsl) {
		...
		weights[4] = Nsl;
		/*
		 * weights[5] = Wrmcrms; weights[6] = Wrmcrmd; weights[7] = Wrmcms; weights[8] =
		 * Wrmcmd; weights[9] = Wmrgvs; weights[10] = Wmrgvd; weights[11] = Wrmrgvs;
		 * weights[12] = Wrmrgvd;
		 */
