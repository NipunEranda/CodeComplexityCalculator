...
<body>
	<div id="resultContainer" class="container-fluid">
		...
		<div id="size" class="size">
			...
			<br />
			<center>
				<%@ include file="components/result_size.jsp"%>
			</center>
		</div>
		<div id="variable" class="variable">
			...
			<br />
			<center>
				<%@ include file="components/result_variables.jsp"%>
			</center>
		</div>
		...
		<div id="inheritance" class="inheritance">
			...
			<br />
			<center>
				<%@ include file="components/inheritanceView.jsp"%>
			</center>
		</div>
		<div id="controlStructure" class="controlStructure">
			...
			<br />
			<center>
				<%@ include file="components/controlStructureView.jsp"%>
			</center>
		</div>
